...
{
    public partial class Form_RegistrasiSupplier : MetroForm
    {
        List<TextBox> list_txt = new List<TextBox>();
        public Form_RegistrasiSupplier()
        {
            InitializeComponent();
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            {              
                try
                {
                    Class.class_Supplier SupplierBaru = new Class.class_Supplier(txtNama.Text, txtAlamat.Text, txtZipcode.Text, txtPhoneNumber.Text, txtEmail.Text);
