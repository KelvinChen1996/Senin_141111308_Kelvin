...
namespace Latihan_POS.Class
{
    class class_Supplier
    {
        ...
        public class_Supplier()
        { }

        public class_Supplier(int id)
        {
            this.id = id;
        }

        public class_Supplier(string nama, string alamat, string zip_code, string phone_number, string email)
        {
            this.nama = nama;
            this.alamat = alamat;
        ...
        public class_Supplier(int id, string nama, string alamat, string zip_code, string phone_number, string email)
        {
            this.id = id;
            this.nama = nama;
            this.alamat = alamat;
